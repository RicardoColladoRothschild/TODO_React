# Repositorio TODO list made with React
...
## Every component
Each of the component create here has it own css file, this css file is save in a folder for the component, 
each component get its own css, and other features. 
